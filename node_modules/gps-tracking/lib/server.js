...
//var refx = db.ref("public/FIXBOT/Registered devices/Data");
    ...
    this.init(function () {
        ...
        _this.server = net.createServer(function (connection) {
            ...
            connection.on('data', function (data) {
                connection.device.emit('data', data, dev);
		...
		console.log("kshdsfhbc");                
               // connection.device.emit('disconnected', connection.uid);
            });

            callback(connection.device, connection);

            connection.device.emit('connected', connection.uid, dev);
